...
public class send_email{
    ...
    // 发件人
    private String from = "minaduki_map1e@163.com";
    ...
    public send_email(String toEmail ){
        to = toEmail;
    ...
    public void sendTextEmail(long Num) throws Exception {
        ...
        // 设置邮件主题
        message.setSubject("家教网注册验证");
        // 设置收件人
        message.setRecipient(Message.RecipientType.TO, new InternetAddress(to));
        // 设置发送时间
        message.setSentDate(new Date());
        // 设置纯文本内容为邮件正文
        String s="您正在注册家教网账号，验证码为: "; s=s+Long.toString(Num);
        message.setText(s);
        // 保存并生成最终的邮件内容
        message.saveChanges();
        ...
        // 打开连接
        transport.connect("minaduki_map1e@163.com", "JIVNYMQJXKPRNXEP");
    ...
    public void sendHtmlEmail(long Num) throws Exception {
        ...
        MimeMessage message = new MimeMessage(session);
        // 设置邮件主题
        message.setSubject("绿坝浏览器的注册验证码");
        // 设置发送人
        message.setFrom(new InternetAddress(from));
        // 设置发送时间
        message.setSentDate(new Date());
    ...
    */
    ...
    static class MyAuthenticator extends Authenticator {
        ...
        private String username = "minaduki_map1e@163.com";

        private String password = "JIVNYMQJXKPRNXEP";
